...
{
    public class ProxyClientX : IDisposable, IWebProxy
    {
        #region IWebProxy
        ...
        public ProxyClientX(string Proxy, ProxyType Type)
            : this(Proxy, null, null, null, Type) { }

        public ProxyClientX(string Proxy, string Username, ProxyType Type)
            : this(Proxy, null, Username, null, Type) { }

        public ProxyClientX(string Proxy, string Username, string Password, ProxyType Type)
            : this(Proxy, null, Username, Password, Type) { }

        public ProxyClientX(string Host, int Port, ProxyType Type)
            : this(Host, Port, null, null, Type) { }

        public ProxyClientX(string Host, int Port, string Username, ProxyType Type)
            : this(Host, Port, Username, null, Type) { }

        public ProxyClientX(string Host, int? Port, string Username, string Password, ProxyType Type)
        {
