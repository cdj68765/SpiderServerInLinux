    ...
    internal class TCPHandler
    {
        ...
        private void HandshakeSendCallback(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                // +-----+-----+-------+------+----------+----------+ | VER | CMD | RSV | ATYP |
                // DST.ADDR | DST.PORT | +-----+-----+-------+------+----------+----------+ | 1 | 1
                // | X'00' | 1 | Variable | 2 | +-----+-----+-------+------+----------+----------+
                // Skip first 3 bytes, and read 2 more bytes to analysis the address. 2 more bytes
                // is designed if address is domain then we don't need to read once more to get the
                // addr length. validate is unnecessary, we did it in first packet, but we can do it
                // in future version
