...
namespace Shadowsocks.Encryption
{
    ...
    public static class OpenSSL
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        [DllImport(DLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr OPENSSL_add_all_algorithms_noconf();

        [SuppressUnmanagedCodeSecurity]
        [DllImport(DLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr OPENSSL_init_crypto();

        [DllImport(DLLNAME)]
        public static extern IntPtr OPENSSL_add_all_algorithms_conf();
    }
}