...
namespace Shadowsocks.Encryption.AEAD
{
        ...
        : EncryptorBase
    {
        ...
        {
            var md = MbedTLS.mbedtls_md_info_from_type(MbedTLS.mbedtls_md_type_t.MBEDTLS_MD_SHA1);
            int ret = MbedTLS.mbedtls_hkdf(md, salt, saltLen, masterKey, keyLen, InfoBytes, InfoBytes.Length, sessionKey,
                keyLen);
        ...
        public override void Decrypt(byte[] buf, int length, byte[] outbuf, out int outlength)
        {
            ...
            while (true)
            {
                ...
                // we have enough data to decrypt one chunk drop chunk len and its tag from buffer
