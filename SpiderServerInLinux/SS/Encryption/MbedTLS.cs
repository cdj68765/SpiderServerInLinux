...
namespace Shadowsocks.Encryption
{
    ...
    {
        private const string DLLNAME = "libmbedcrypto";
        ...
        [DllImport(DLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern int mbedtls_hkdf(IntPtr md, byte[] salt,
            int salt_len, byte[] ikm, int ikm_len,
            byte[] info, int info_len, byte[] okm,
            int okm_len);

        [DllImport(DLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr mbedtls_md_info_from_type(mbedtls_md_type_t md);

        public enum mbedtls_md_type_t
        {
