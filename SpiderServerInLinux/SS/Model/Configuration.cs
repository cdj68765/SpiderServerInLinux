...
namespace Shadowsocks.Model
{
    ...
    public class Configuration
    {
        ...
        /// <summary>
        /// Used by multiple forms to validate a server. Communication is done by throwing exceptions.
        /// </summary>
        ...
        {
            // Verify if the configured geosite groups exist. Reset to default if ANY one of the
        ...
        /// <returns>True if all groups are valid. False if any one of them is invalid.</returns>
