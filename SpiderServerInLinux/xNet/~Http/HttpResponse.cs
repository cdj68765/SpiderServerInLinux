...
namespace xNet
{
    ...
    public sealed class HttpResponse
    {
        ...
        // Обёртка для массива байтов. Указывает реальное количество байтов содержащихся в массиве.
        ...
        // Данный класс используется при загрузки сжатых данных. Он позволяет определить точное
        // количество считаных байт (сжатых данных). Это нужно, так как потоки для считывания сжатых
        // данных сообщают количество байт уже преобразованных данных.
        ...
        /// </summary>
        /// <value>
        /// Кодировка тела сообщения, если соответствующий заголок задан, иначе значение заданное в
        /// <see cref="xNet.Net.HttpRequest"/>. Если и оно не задано, то значение <see cref="System.Text.Encoding.Default"/>.
        /// </value>
        ...
        /// </summary>
        /// <remarks>
        /// Если куки были установлены в <see cref="xNet.Net.HttpRequest"/> и значение свойства <see
        /// cref="xNet.Net.CookieDictionary.IsLocked"/> равно <see langword="true"/>, то будут
        /// созданы новые куки.
        /// </remarks>
        ...
        /// </summary>
        /// <returns>
        /// Если тело сообщения отсутствует, или оно уже было загружено, то будет возвращён пустой
        /// массив байтов.
        /// </returns>
        ...
        /// <summary>
        /// Загружает тело сообщения и сохраняет его в новый файл по указанному пути. Если файл уже
        ...
        /// </exception>
        /// <exception cref="System.ArgumentException">
        /// Значение параметра <paramref name="path"/> является пустой строкой, содержит только
        /// пробелы или содержит недопустимые символы.
        /// </exception>
        /// <exception cref="System.IO.PathTooLongException">
        /// Указанный путь, имя файла или и то и другое превышает наибольшую возможную длину,
        /// определенную системой. Например, для платформ на основе Windows длина пути не должна
        /// превышать 248 знаков, а имена файлов не должны содержать более 260 знаков.
        /// </exception>
        /// <exception cref="System.IO.FileNotFoundException">
        /// Значение параметра <paramref name="path"/> указывает на несуществующий файл.
        /// </exception>
        /// <exception cref="System.IO.DirectoryNotFoundException">
        /// Значение параметра <paramref name="path"/> указывает на недопустимый путь.
        /// </exception>
        ...
        /// -или- Значение параметра <paramref name="path"/> определяет каталог.
        /// -или- Вызывающий оператор не имеет необходимого разрешения.
        /// </exception>
        /// <exception cref="xNet.Net.HttpException">Ошибка при работе с HTTP-протоколом.</exception>
        ...
        private void SetCookie(string value)
        {
            ...
            else
            {
                ...
                #endregion Получаем время, которое куки будет действителен
            }
        ...
        #endregion Загрузка начальных данных
        ...
        #endregion Загрузка тела сообщения
        ...
        #endregion Получение значения HTTP-заголовков
