...
namespace xNet
{
    ...
    public class Socks5ProxyClient : ProxyClient
    {
        ...
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="Socks5ProxyClient"/> заданным хостом
        /// прокси-сервера, и устанавливает порт равным - 1080.
        /// </summary>
        ...
        /// <summary>
        /// Преобразует строку в экземпляр класса <see cref="Socks5ProxyClient"/>. Возвращает
        ...
        /// </param>
        /// <param name="result">
        /// Если преобразование выполнено успешно, то содержит экземпляр класса <see
        /// cref="Socks5ProxyClient"/>, иначе <see langword="null"/>.
        /// </param>
        /// <returns>
