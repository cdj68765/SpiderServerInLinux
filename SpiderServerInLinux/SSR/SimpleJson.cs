...
namespace SimpleJson
{
 ...
 IDictionary<string, object>
    {
...
#if SIMPLE_JSON_DYNAMIC
        /// <summary>
        /// Provides implementation for type conversion operations. Classes derived from the <see
        /// cref="T:System.Dynamic.DynamicObject"/> class can override this method to specify dynamic
        /// behavior for operations that convert an object from one type to another.
        /// </summary>
        /// <param name="binder">
        /// Provides information about the conversion operation. The binder.Type property provides
        ...
        /// cref="T:System.Dynamic.DynamicObject"/> class, binder.Type returns the <see
        /// cref="T:System.String"/> type. The binder.Explicit property provides information about
        /// the kind of conversion that occurs. It returns true for explicit conversion and false for
        /// implicit conversion.
        /// </param>
 ...
 (targetType == typeof(IDictionary))
        ...
        /// <summary>
        /// Provides the implementation for operations that delete an object member. This method is
        ...
        /// DynamicObject class, <paramref name="indexes"/> is equal to 3.
        /// </param>
        ...
        /// from the <see cref="T:System.Dynamic.DynamicObject"/> class, <paramref name="indexes"/>
        /// is equal to 3.
        /// </param>
        /// <param name="value">
...
namespace SimpleJson
{
    ...
    /// <summary>
    /// This class encodes and decodes JSON strings. Spec. details, see http://www.json.org/ /// JSON
    /// uses Arrays and Objects. These correspond here to the datatypes
    /// JsonArray(IList&lt;object&gt;) and JsonObject(IDictionary&lt;string,object&gt;). All numbers
    /// are parsed to doubles.
    /// </summary>
 ...
 class SimpleJson
    {
        ...
        /// <returns>
        /// An IList&lt;object&gt;, a IDictionary&lt;string,object&gt;, a double, a string, null,
        /// true, or false
        /// </returns>
 ...
 class DataContractJsonSerializerStrategy : PocoJsonSerializerStrategy
    ...
    #endregion Simple Json Serializer Strategies
