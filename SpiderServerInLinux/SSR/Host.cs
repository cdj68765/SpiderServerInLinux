...
namespace Shadowsocks.Model
{
    ...
    {
        private Dictionary<string, HostNode> root = new Dictionary<string, HostNode>();
        private IPSegment ips = new IPSegment("remoteproxy");

        private static HostMap instance = new HostMap();
        private const string HOST_FILENAME = "user.rule";
