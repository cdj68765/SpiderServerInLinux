...
{
    /// <summary>
    /// The LiteDB4 database. Used for create a LiteDB4 instance and use all storage resources. It's the database connection
    /// </summary>
    public partial class LiteDatabase : IDisposable
    {
        ...
        /// <summary>
        /// Starts LiteDB4 database using a connection string for file system database
        /// </summary>
        ...
        /// <summary>
        /// Starts LiteDB4 database using a Stream disk
        /// </summary>
        ...
        /// <summary>
        /// Starts LiteDB4 database using a custom IDiskService with all parameters available
        /// </summary>
